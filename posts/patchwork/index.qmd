...
#| fig-height: 15
#| out-width: 4in
#| fig-link: index_files/figure-html/byrow-1.png
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: !expr paste0("index_files/figure-html/", knitr::opts_current$get("label"), "-1.png")

(p1 | (p2 / p3)) + 
  plot_annotation(title = 'Lots of data about penguins',
    subtitle = 'There\'s never too much info about penguins', tag_levels = "A",
    theme = theme(plot.title = element_text(hjust = .5, color = "green"),
        plot.tag = element_text(size = 20)))
```
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/widths-1.png
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/letter_design-1.png
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/wrap_plots-1.png
...
The alternative way to specify a layout is with one or more `area()`s, which take arguments for the `t`op, `l`eft, b`ottom,  and `r`ight bounds of a grid.  The grid is specified in rows and columns, with row 1 column 1 being the top left, and numbers increasing as you go down and right.  You can have plots overlap with this type of specification.
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/area-1.png
layout <- c(
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/inset-1.png
...
```{r}
#| code-fold: true
#| code-summary: "Reset `p1` and `p2` to their original theme"
...
#| fig-height: 10
#| out-width: 100%
#| fig-link: index_files/figure-html/collect-1.png
