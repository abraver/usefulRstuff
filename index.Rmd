...
This will give a df showing package names, versions, and where they're from (CRAN or github).

Then filter by source and install as appropriate.  Will need to install `devtools` first
